package com.jit.skiad.security;

import com.jit.skiad.domain.Permission;
import com.jit.skiad.domain.Role;
import com.jit.skiad.mapper.PermissionMapper;
import com.jit.skiad.mapper.RoleMapper;
import com.jit.skiad.mapper.UserMapper;
import com.jit.skiad.domain.User;
import com.jit.skiad.rbac.MyGrantedAuthority;
...
//            Collection<GrantedAuthority> grantedAuthorities = obtionGrantedAuthorities(user);
            ...
            return new JwtUser(user.getId(),user.getUsername(),user.getPassword(),grantedAuthorities,user.getRegister_time());
        } else {
